...
- Show only one language at a time. Default to CN.
- Add a `language` config setting where `""` means default, `"cn"` forces Chinese, and `"en"` forces English.
